...
local normal_mode_mappings = {
  ...
  ["v"] = { '<C-W>v',                                    'split right' },
  ["V"] = { '<C-W>s',                                    'split below' },
  ["e"] = {'<cmd>NvimTreeOpen<cr>',                       'Open Tree'},
  ["<leader>"] = {
    name = "Quick actions",
    x = {'<cmd>luafile %<cr>', 'Luafile %'},
    w = {'<cmd>:w<cr>', 'Write'},
  ...
  t = {
    ...
    h = {'<cmd>ToggleTerm size=15 dir=./ direction=horizontal<cr>', 'Horizontal'},
    f = {'<cmd>ToggleTerm size=15 dir=./ direction=float<cr>', 'Float'},
    v = {'<cmd>ToggleTerm size=15 dir=./ direction=vertical<cr>', 'Vertical'},
...
function WhichKeyRust()
  wkl.register({
    d = {
      name = 'Debug',
      c = {'<cmd>RustDebuggables<cr>', 'Continue'},
      d = {'<cmd>RustDebuggables<cr>', 'Continue'},
    },
    a = {
      name = 'Actions',
...
local function attach_rust(bufnr)
  wk.register({
    d = {
      name = 'Debug',
      c = {'<cmd>RustDebuggables<cr>', 'Continue'},
